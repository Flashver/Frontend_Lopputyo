...
function CourseList() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1200px] bg-yellow-200 text-black shadow-lg border-8 border-yellow-900 p-6">
      <div className="bg-yellow-100 border-8 border-yellow-900 p-2 mx-auto inline-block 
          ...
          {courses.map((course) => (
            <div
              ...
              className="relative p-4 border-8 border-yellow-900 bg-yellow-100 text-yellow-900 
                        font-['Press_Start_2P'] shadow-[5px_5px_0px_#5A3211,-5px_-5px_0px_#A67B5B,inset_0px_0px_8px_rgba(0,0,0,0.6)]"
            >
