...
function CourseList() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1200px] bg-yellow-200 text-black shadow-lg border-8 border-yellow-900 p-6">
      <div className="bg-yellow-100 border-8 border-yellow-900 p-2 mx-auto inline-block shadow-[5px_5px_0px_#5A3211]">
      ...
      {courses.length === 0 ? (
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          {courses.map((course) => (
            <div
              key={course.id}
              className="relative p-4 border-8 border-yellow-900 bg-yellow-100 text-yellow-900 font-['Press_Start_2P'] shadow-[5px_5px_0px_#5A3211]"
            >
